...
export class CreatePostAndTagTable1610953683724 implements MigrationInterface {
    name = 'CreatePostAndTagTable1610953683724'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `post` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `desc` varchar(255) NULL, `alias` varchar(255) NOT NULL, `text` text NOT NULL, `status` enum ('d', 'p') NOT NULL DEFAULT 'd', `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `published_at` datetime NULL, UNIQUE INDEX `IDX_394783ef3bf52330ce2a8b1d35` (`alias`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("DROP INDEX `IDX_394783ef3bf52330ce2a8b1d35` ON `post`");
